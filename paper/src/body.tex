...
% so only the notes on position of the first quiver will be taken); 
...
\iris{\textbf{Resolved!} Below is the music related background and my previous description on explaining the fractal dimensions. 
If there are still bits that could be helpful, they should probably come in this section. 
\textbf{@Victor, @Anja, @Wouter, @Remco}, could you please take a look and see if anything is worth mentioning?
(Maybe even a rough hand annotation circling out where you find helpful? I'll try to edit them in the structure.)}
