...
converges to, for $s \rightarrow \infty$.  In \Cref{fig:egboxcount} we show this
...
values converge very slowly.  \victor{I'm not very attached to the plot \Cref{fig:egplots},
